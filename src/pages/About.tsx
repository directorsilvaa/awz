            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
                {[
                  ...
                  { value: '500+', label: 'Processos Gerenciados', icon: Scale },
                  { value: '50+', label: 'Profissionais', icon: Users },
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
              <div className="group bg-white rounded-3xl p-12 shadow-[0_20px_50px_rgba(46,125,50,0.07)] hover:shadow-[0_30px_60px_rgba(46,125,50,0.15)] transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                ...
                <h3 className="text-2xl font-bold mb-6 text-gray-800 group-hover:text-primary transition-colors duration-300">Excelência Jurídica</h3>
              ...
              <div className="group bg-white rounded-3xl p-12 shadow-[0_20px_50px_rgba(46,125,50,0.07)] hover:shadow-[0_30px_60px_rgba(46,125,50,0.15)] transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                ...
                <h3 className="text-2xl font-bold mb-6 text-gray-800 group-hover:text-primary transition-colors duration-300">Equipe Multidisciplinar</h3>
                <p className="text-gray-700 leading-relaxed text-lg mb-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="order-1 lg:order-2">
                  ...
                  <p className="text-xl leading-relaxed text-white/90 mb-8">
                    ...
                    judicial mais moderna e célere.
                  </p>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      'Segurança necessária para superação da crise',
                      'Tecnologia para todos os participantes'
                    ].map((feature, index) => (
